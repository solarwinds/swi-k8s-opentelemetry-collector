...
require (
	...
	github.com/solarwinds/swi-k8s-opentelemetry-collector/internal/coreinternal v0.113.0
	github.com/solarwinds/swi-k8s-opentelemetry-collector/internal/k8sconfig v0.113.0
