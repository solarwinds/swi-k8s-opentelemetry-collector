# SolarWinds Kubernetes Attributes Processor
...
The swk8sattributesprocessor can also set resource attributes from k8s labels and annotations of pods and namespaces.
...
```yaml
# swk8sattributes config for agent
swk8sattributes:
  passthrough: true
```
...
There are some edge-cases and scenarios where swk8sattributes will not work properly.
