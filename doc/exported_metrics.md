...
| k8s.node.network.bytes_received | Gauge |  | Rate of bytes received of all pods on node | custom |
| k8s.node.network.bytes_transmitted | Gauge |  | Rate of bytes transmitted of all pods on node | custom |
| k8s.node.network.packets_received | Gauge |  | Rate  of packets received of all pods on node | custom |
| k8s.node.network.packets_transmitted | Gauge |  | Rate of packets transmitted of all pods on node | custom |
| k8s.node.network.receive_packets_dropped | Gauge |  | Rate of packets dropped while receiving of all pods on node | custom |
| k8s.node.network.transmit_packets_dropped | Gauge |  | Rate of packets dropped while transmitting of all pods on node | custom |
