...
transform/istio-parse-service-fqdn:
  ...
  metric_statements:
    - context: datapoint
      statements:
        - set(datapoint.attributes["destination_service_name"], datapoint.attributes["destination_service"]) where IsMatch(datapoint.attributes["destination_service"], "^([a-z0-9][-a-z0-9]).([a-z0-9][-a-z0-9]).svc(.[a-z0-9.-]+)?(?::\d+)?$ ") and datapoint.attributes["destination_service_name"] == "PassthroughCluster"
        - replace_pattern(datapoint.attributes["destination_service_name"], "^([a-zA-Z0-9][-a-zA-Z0-9]*)\\.([a-zA-Z0-9][-a-zA-Z0-9]*)\\.svc\\.cluster\\.local.*$", "$$1") where datapoint.attributes["destination_service_name"] != nil and IsMatch(datapoint.attributes["destination_service_name"], "^([a-z0-9][-a-z0-9]).([a-z0-9][-a-z0-9]).svc(.[a-z0-9.-]+)?(?::\d+)?$ ")
        ...
        - replace_pattern(datapoint.attributes["destination_service_namespace"], "^([a-zA-Z0-9][-a-zA-Z0-9]*)\\.([a-zA-Z0-9][-a-zA-Z0-9]*)\\.svc\\.cluster\\.local.*$", "$$2") where datapoint.attributes["destination_service_namespace"] != nil and IsMatch(datapoint.attributes["destination_service_namespace"], "^([a-z0-9][-a-z0-9]).([a-z0-9][-a-z0-9]).svc(.[a-z0-9.-]+)?(?::\d+)?$ ")
