...
def test_metric_names_generated():
    retry_until_ok(url, assert_test_metric_names_found, print_failure_metric_names)

def test_metric_line_count_generated():
    retry_until_ok(url, assert_test_metrics_line_length_match, print_failure_line_count)
