#!/usr/bin/env python3
"""
Events Integration Tests Runner
Runs only the events-related integration tests.
"""
...
def main():
    ...
    print("Starting events integration tests...")
    ...
    if exit_code == 0:
        ...
        print(f"\n💥 Events tests failed with exit code {exit_code}")
